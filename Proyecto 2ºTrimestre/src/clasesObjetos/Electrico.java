...
public abstract class Electrico extends Vehiculo {
	...
	public void setTiempoRecarga(int tiempoRecarga) throws TiempoRecargaNoValidoException {
		if (tiempoRecarga>minTiempoRecarga && tiempoRecarga<maxTiempoRecarga)
		{
			...
			throw new TiempoRecargaNoValidoException("Tiempo de recarga menor o igual a"+ minTiempoRecarga+ " � mayor que"+ maxTiempoRecarga);
		}
	}
	...
	//	this.setElectrico(true); //Todos los que hereden de electrico son electricos (para el c�lculo del alquiler)
	}
